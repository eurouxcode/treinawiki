...
<body>
    ...
    <main class="artigo">
        <section>
            ...
            <div>uma linguagem de marcação utilizada na construção de páginas na Web
            </div>
            <hr>
            <p class="paragrafo"><strong>HTML</strong> (abreviação para a <a target="_blank" href="https://pt.m.wikipedia.org/wiki/L%C3%ADngua_inglesa">expressão inglesa</a> <em>HyperText Markup Language</em>, que significa: "Linguagem de Marcação de Hipertexto" é uma <a target="_blank" href="https://pt.m.wikipedia.org/wiki/Linguagem_de_marca%C3%A7%C3%A3o">linguagem de marcação</a> utilizada na construção de <a target="_blank" href="https://pt.m.wikipedia.org/wiki/P%C3%A1gina_web">páginas na Web</a>. Documentos HTML podem ser interpretados por <a target="_blank" href="https://pt.m.wikipedia.org/wiki/Navegador_(inform%C3%A1tica)">navegadores</a>. A <a target="_blank" href="https://pt.m.wikipedia.org/wiki/Tecnologia">tecnologia</a> é fruto da junção entre os padrões <a target="_blank" href="https://pt.m.wikipedia.org/wiki/HyTime">HyTime</a> e <a target="_blank" href="https://pt.m.wikipedia.org/wiki/SGML">SGML</a>.</p>
    
            <p class="paragrafo"><a target="_blank" href="https://pt.m.wikipedia.org/wiki/HyTime">HyTime</a> é um padrão para a representação estruturada de hipermídia e conteúdo baseado em tempo. Um documento é visto como um conjunto de eventos concorrentes dependentes de tempo (como áudio, vídeo, etc.), conectados por <a target="_blank" href="https://pt.m.wikipedia.org/wiki/Hiperliga%C3%A7%C3%A3o">hiperligações</a> (em inglês: hyperlink e link). O padrão é independente de outros padrões de processamento de texto em geral.</p>
    
            <p class="paragrafo"><a target="_blank" href="https://pt.m.wikipedia.org/wiki/SGML">SGML</a> é um padrão de formatação de textos. Não foi desenvolvido para hipertexto, mas tornou-se conveniente para transformar documentos em hiper-objetos e para descrever as ligações.</p>
        </section>
        ...
        <section class="indice">
            ...
            <ul>
                ...
                <li><a href="#marcas-tags">Marcas (tags)</a></li>
                <li><a href="#edicao-documentos-html">Edição de documentos HTML</a></li>
            </ul>
        </section>        
        ...
        <section>
            ...
            <figure class="figura-artigo">
                <a href="#"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Berners-Lee_announcing_W3F.jpg/220px-Berners-Lee_announcing_W3F.jpg" alt="Tim Berners-Lee em 2008."></a>
                <figcaption> <a href="#">Tim Berners-Lee</a> em 2008.</figcaption>
            </figure>
        ...
        <section>
            ...
            <p class="paragrafo">Todo documento HTML possui marcadores (do inglês: tags), palavras entre parênteses angulares (chevron) (<code class="codigo">&lt;</code> e <code class="codigo">&gt;</code>); esses marcadores são os comandos de formatação da linguagem. Um elemento é formado por um nome de marcador (tag), atributos, valores e filhos (que podem ser outros elementos ou texto). Os atributos modificam os resultados padrões dos elementos e os valores caracterizam essa mudança. Exemplo de um elemento simples (não possui filhos):</p>
        </section>
        ...
        <section>
            ...
            <p>Os documentos em HTML são arquivos de texto simples que podem ser criados e editados em qualquer editor de textos comum, como o Bloco de Notas do Windows, ou o TextEdit, do Macintosh. Para facilitar a produção de documentos, no mercado existem editores HTML específicos, com recursos sofisticados, que facilitam a realização de tarefas repetitivas, inserção de objetos, elaboração de tabelas e outros recursos (Ver lista abaixo). Basicamente dividem-se em dois tipos:
                ...
                <ul>
                    ...
                    <li>Editores WYSIWYG: oferecem ambiente de edição com um "esboço" resultado final das marcações
                    </li>
                </ul>
            </p>
        </section>
